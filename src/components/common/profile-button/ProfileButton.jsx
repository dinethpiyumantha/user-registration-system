    ...
    <div className="relative">
      ...
      {isDropdownOpen && (
        <div className="absolute right-0 mt-5 p-2 w-48 bg-lightgray border rounded-xl shadow-lg">
          <button onClick={ () => navigate("/profile-edit") } className={`block w-full px-4 mb-1 py-2 text-left rounded-lg font-semibold ${edit? 'text-primary':'text-gray-800'} hover:bg-gray-100 border-grayaccent`}>
            Edit Profile
          </button>
